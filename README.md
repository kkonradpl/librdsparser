...
- ```A201200674697363``` (16 bytes, i.e. 4×16-bit blocks, with no information about error correction),

- ```34DD054AE3054F2015``` (16 bytes + 2 bytes with error correction levels).
