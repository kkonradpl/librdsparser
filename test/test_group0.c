...
group0_test_get_ta_false(void **state)
{
    ...
    assert_int_equal(rdsparser_group0_get_ta(data), false);
}
...
group0_test_get_ta_true(void **state)
{
    ...
    assert_int_equal(rdsparser_group0_get_ta(data), true);
}
...
group0_test_get_ms_true(void **state)
{
    ...
    assert_int_equal(rdsparser_group0_get_ms(data), true);
}
...
group0_test_get_ms_false(void **state)
{
    ...
    assert_int_equal(rdsparser_group0_get_ms(data), false);
}
...
group0_test_get_ps_pos_0(void **state)
{
    ...
    assert_int_equal(rdsparser_group0_get_ps_pos(data), 0);
}
...
group0_test_get_ps_pos_3(void **state)
{
    ...
    assert_int_equal(rdsparser_group0_get_ps_pos(data), 3);
}
